...
import {setEqualAC, setNum1AC, setNum2AC, setOperandAC} from "../../../store/calc-reducer";
...
export const Equal: React.FC<EqualType> = ({disabled}) => {
    ...
    return <SuperBtn onClick={resultHandler} disabled={disabled} xType={"secondary"}>=</SuperBtn>
};